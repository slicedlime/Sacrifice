...
tellraw @s [{"text":"- "},{"text":"[","color":"gold","bold": true},{"text":"Change Seed: ", "color":"green", "extra": [{"score":{"objective":"Registry","name":"$rng"}, "color": "aqua"}],"clickEvent":{"action":"suggest_command","value":"/trigger Seed set "}},{"text":"]","color":"gold", "bold": true}]
