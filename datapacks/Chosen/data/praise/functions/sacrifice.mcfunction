...
execute if entity @e[tag=Current,tag=CookedBeef] at @e[tag=Main] run tag @e[type=item,distance=..2,nbt={Item:{id:"minecraft:cooked_beef"},OnGround:1b}] add Accepted
execute if entity @e[tag=Current,tag=CookedPorkchop] at @e[tag=Main] run tag @e[type=item,distance=..2,nbt={Item:{id:"minecraft:cooked_porkchop"},OnGround:1b}] add Accepted
...
execute if entity @e[tag=Current,tag=Bed] at @e[tag=Main] run tag @e[type=item,distance=..2,nbt={Item:{id:"minecraft:white_bed"},OnGround:1b}] add Accepted
execute if entity @e[tag=Current,tag=Bed] at @e[tag=Main] run tag @e[type=item,distance=..2,nbt={Item:{id:"minecraft:orange_bed"},OnGround:1b}] add Accepted
execute if entity @e[tag=Current,tag=Bed] at @e[tag=Main] run tag @e[type=item,distance=..2,nbt={Item:{id:"minecraft:magenta_bed"},OnGround:1b}] add Accepted
execute if entity @e[tag=Current,tag=Bed] at @e[tag=Main] run tag @e[type=item,distance=..2,nbt={Item:{id:"minecraft:light_blue_bed"},OnGround:1b}] add Accepted
execute if entity @e[tag=Current,tag=Bed] at @e[tag=Main] run tag @e[type=item,distance=..2,nbt={Item:{id:"minecraft:yellow_bed"},OnGround:1b}] add Accepted
execute if entity @e[tag=Current,tag=Bed] at @e[tag=Main] run tag @e[type=item,distance=..2,nbt={Item:{id:"minecraft:lime_bed"},OnGround:1b}] add Accepted
execute if entity @e[tag=Current,tag=Bed] at @e[tag=Main] run tag @e[type=item,distance=..2,nbt={Item:{id:"minecraft:pink_bed"},OnGround:1b}] add Accepted
execute if entity @e[tag=Current,tag=Bed] at @e[tag=Main] run tag @e[type=item,distance=..2,nbt={Item:{id:"minecraft:gray_bed"},OnGround:1b}] add Accepted
execute if entity @e[tag=Current,tag=Bed] at @e[tag=Main] run tag @e[type=item,distance=..2,nbt={Item:{id:"minecraft:light_gray_bed"},OnGround:1b}] add Accepted
execute if entity @e[tag=Current,tag=Bed] at @e[tag=Main] run tag @e[type=item,distance=..2,nbt={Item:{id:"minecraft:cyan_bed"},OnGround:1b}] add Accepted
execute if entity @e[tag=Current,tag=Bed] at @e[tag=Main] run tag @e[type=item,distance=..2,nbt={Item:{id:"minecraft:purple_bed"},OnGround:1b}] add Accepted
execute if entity @e[tag=Current,tag=Bed] at @e[tag=Main] run tag @e[type=item,distance=..2,nbt={Item:{id:"minecraft:blue_bed"},OnGround:1b}] add Accepted
execute if entity @e[tag=Current,tag=Bed] at @e[tag=Main] run tag @e[type=item,distance=..2,nbt={Item:{id:"minecraft:brown_bed"},OnGround:1b}] add Accepted
...
execute if entity @e[tag=Current,tag=RabbitStew] at @e[tag=Main] run tag @e[type=item,distance=..2,nbt={Item:{id:"minecraft:rabbit_stew"},OnGround:1b}] add Accepted
...
execute if entity @e[tag=Current,tag=TNT] at @e[tag=Main] run tag @e[type=item,distance=..2,nbt={Item:{id:"minecraft:tnt"},OnGround:1b}] add Accepted
...
execute if entity @e[tag=Current,tag=GrassBlock] at @e[tag=Main] run tag @e[type=item,distance=..2,nbt={Item:{id:"minecraft:grass_block"},OnGround:1b}] add Accepted
execute if entity @e[tag=Current,tag=GlisteringMelon] at @e[tag=Main] run tag @e[type=item,distance=..2,nbt={Item:{id:"minecraft:glistering_melon_slice"},OnGround:1b}] add Accepted
...
execute if entity @e[tag=Current,tag=GoldenCarrot] at @e[tag=Main] run tag @e[type=item,distance=..2,nbt={Item:{id:"minecraft:golden_carrot"},OnGround:1b}] add Accepted
execute if entity @e[tag=Current,tag=SpectralArrow] at @e[tag=Main] run tag @e[type=item,distance=..2,nbt={Item:{id:"minecraft:spectral_arrow"},OnGround:1b}] add Accepted
...
execute if entity @e[tag=Current,tag=Bamboo] at @e[tag=Main] run tag @e[type=item,distance=..2,nbt={Item:{id:"minecraft:bamboo"},OnGround:1b}] add Accepted
...
execute if entity @e[tag=Current,tag=HoneyBottle] at @e[tag=Main] run tag @e[type=item,distance=..2,nbt={Item:{id:"minecraft:honey_bottle"},OnGround:1b}] add Accepted
...
execute if entity @s[tag=Accepted] run function praise:sacrificeitem
